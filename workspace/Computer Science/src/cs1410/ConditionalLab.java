...
public class ConditionalLab extends JFrame implements ActionListener {
	
	public final static int REFRESH_RATE = 5;  // Animation refresh rate in milliseconds
	...
	public static void main (String[] args) {
		ConditionalLab g = new ConditionalLab();
		g.setSize(400, 400);
		g.setVisible(true);
	}
