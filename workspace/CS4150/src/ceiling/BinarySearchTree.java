...
public class BinarySearchTree<Type extends Comparable<? super Type>> {
	...
	public class BinaryNode 
	{
		...
		public boolean isSameTree(BinaryNode binNode){
			boolean retVal = true;
			if(this.left == null && binNode.left != null) return false;
			if(this.right == null && binNode.right != null) return false;
			if(this.left != null && binNode.left == null) return false;
			if(this.right != null && binNode.right == null) return false;
			if(this.left == null && binNode.left == null && this.right == null && binNode.right == null) return true;
			if(this.left!= null){
				BinaryNode left = binNode.getLeft();
				retVal = this.getLeft().isSameTree(left);
			}
			if(retVal && this.right!=null){
				BinaryNode right = binNode.getRight();
				retVal = this.getRight().isSameTree(right);
			}
