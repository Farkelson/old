...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
    ...
    lib2.add(9781843190004L, "Moyra Caldecott",	"Weapons of the Wolfhound");
    ...
    //Start of additional testing 
    LibraryGeneric libS = new LibraryGeneric();
    libS.addAll("Mushroom_Publishing.txt");
    System.out.println("Testing get order by ISBN");
    System.out.println(libS.getInventoryList());
    
    System.out.println("Testing get order by Author");
    System.out.println(libS.getOrderedByAuthor());
    
    System.out.println("Testing get order by Due Date");
    libS.checkout(9781843190004L, "tod", 1, 1, 1999);
    libS.checkout(9781843190011L, "tod", 1, 2, 1999);
    libS.checkout(9781843190028L, "tod", 1, 3, 1999);    
    System.out.println(libS.getOverdueList(1, 1, 2000));
